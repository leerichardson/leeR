...
I want to write as much of my code as possible using C, only using R for input data and analyzing the output. Taylor pointed me to the [the following R package](https://github.com/statsmaths/glmgen), which contains both a c library, and an R package calling this C library. In addition, Taylor wrote an R package called _primesum_, implementing a condensed version of the _glmgen_ package. 
